        ...
        <Container>
          <Row className="justify-content-between align-items-center mb-5 mb-lg-7">
            <Col lg={5} className="order-lg-2 mb-5 mb-lg-0">
              ...
              <p className="mb-4">
                Common Sense is an admin dashboard template that is built using
  ...
  <Button variant="primary" className="m-1">Primary</Button>
          ...
          <Row className="justify-content-between align-items-center">
            <Col lg={5} className="order-lg-2 mb-5 mb-lg-0">
              ...
              <p className="mb-4">
                Common Sense is built using the latest version of Bootstrap 5
          ...
          <Row>
            <Col xs={12} lg={8}>
              ...
              <p className="lead mb-4 me-lg-6">
                ...
                out the premium version of Common Sense Dashboard in the
