...
export default () => (
  <Switch>
    ...
    />
    <SimpleRoute exact path={Routes.Signin.path} component={Signin} />
    <SimpleRoute exact path={Routes.Signup.path} component={Signup} />
    <SimpleRoute
      exact
    ...
    />
    <SimpleRoute exact path={Routes.Lock.path} component={Lock} />
    <SimpleRoute exact path={Routes.NotFound.path} component={NotFoundPage} />
    <SimpleRoute exact path={Routes.ServerError.path} component={ServerError} />
